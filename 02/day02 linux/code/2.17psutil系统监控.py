...
print(
    memory_usage
)  # svmem(total=17123737600, available=4217442304, percent=75.4, used=12906295296, free=4217442304)
# 获取使用率可用,已使用
...
print(
    disk_usage
)  # sdiskusage(total=1000186310656, used=517084291072, free=483102019584, percent=51.7)
...
# 6.获取开机时间  unix时间
start_time = datetime.datetime.fromtimestamp(psutil.boot_time()).strftime(
    "%Y-%m-%d %H:%M:%S"
)
